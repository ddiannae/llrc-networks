################################################################################
## This script calculates network, vertex, and interaction attributes for gene
## networks using igraph. Metrics include centrality, density, transitivity,
## number of components, and more. Requires as input the interactions and
## vertices tables generated by networkTables.R.
##
## Inputs:
...
##
## Outputs:
##   - Network statistics table (TSV)
##   - Node (vertex) attributes table (TSV)
##   - Edge attributes table (TSV)
##   - igraph network object (RData)
################################################################################
